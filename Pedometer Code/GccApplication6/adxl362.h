...
// USI pin definitions
#define ADXL_DDR     DDRB
#define ADXL_PORT    PORTB
#define ADXL_MOSI    PINB3
#define ADXL_MISO    PINB4
#define ADXL_SCK     PINB5
#define ADXL_CS      PINB2
#define ADXL_CS_HIGH ADXL_PORT |= (1 << ADXL_CS)
#define ADXL_CS_LOW  ADXL_PORT &= ~(1 << ADXL_CS)

// interrupt pin definitions if ya want em
#define ADXL362_INT1_DDR  DDRD
#define ADXL362_INT1_PORT PORTD
#define ADXL362_INT1_PIN  PIND
//#define ADXL362_INT2_DDR  DDRA
//#define ADXL362_INT2_PORT PORTA
//#define ADXL362_INT2_PIN  PINA
#define ADXL362_INT1      PIND2
